            ...
            <div className="max-w-7xl mx-auto w-full relative z-10">
                <header className="flex justify-between items-center mb-12 border-b border-brand-accent/20 pb-6">
                    ...
                    <div className="flex items-center gap-4 bg-black/40 px-6 py-2 rounded-full border border-brand-accent/30">
                        <span className="text-brand-accent font-mono text-sm">ONLINE_USERS:</span>
                ...
                {gameState === 'lobby' && (
                    <div className="flex flex-col items-center justify-center h-[60vh]">
                        ...
                        <p className="text-3xl text-brand-accent mb-12 font-mono tracking-widest animate-pulse">SCAN TO INITIALIZE</p>
                        ...
                        <div className="mt-16 flex flex-wrap gap-4 justify-center max-w-4xl">
                            {participants.map((p) => (
                ...
                {(gameState === 'show_first_q' || gameState === 'show_q_wait_for_draw') && (
                    <div className="flex flex-col items-center justify-center h-[60vh] text-center">
                        <div className="mb-6 text-brand-accent font-mono tracking-widest text-xl border-b border-brand-accent/30 pb-2 px-8">INCOMING QUERY FROM</div>
                    ...
                    <div className="flex flex-col items-center justify-center h-[60vh] text-center">
                        <div className="flex items-center gap-16 mb-16">
                            <div className="text-center opacity-60 scale-90">
                                <div className="text-sm text-brand-accent font-mono mb-2">SOURCE</div>
                            ...
                            <div className="text-center scale-110 transform transition-transform p-8 border border-brand-primary/30 bg-brand-primary/5 rounded-xl shadow-[0_0_30px_rgba(255,183,3,0.1)]">
                                <div className="text-sm text-brand-primary font-mono mb-2">TARGET</div>
                ...
                {gameState === 'show_next_q_transition' && (
                    <div className="flex flex-col items-center justify-center h-[60vh]">
                        <h2 className="text-5xl font-bold text-brand-accent animate-pulse font-mono">SYSTEM UPDATING...</h2>
                    </div>
                )}
